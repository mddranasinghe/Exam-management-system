	...
	<DIV class="wapper">
        <section class="sec">
                    ...
                    <div style="float:center;width:1200px;height:100%;background-color:#white;margin-left:30px;margin-top:0px;"> <!-- margin left- eka wenas karahan -->
                        ...
                        <form name="Registration" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" >
                            <div class="login"> 
                        ...
                        <input type="text" name="gender"id="gender" placeholder="gender"style="width: 200px;height: 35px;" value="<?php echo htmlspecialchars($gender); ?>">
                            ...
                            <div>
                            <label for="Mobile_Phone_no">5. Mobile Phone no   &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp:</label>
                            ...
                            <div>
                            <label for="Date_of_admission">6. Date of admission  &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp:</label>
