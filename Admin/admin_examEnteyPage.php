        ...
        <section class="sec">
			...
			<div class ="book_img">
						...
						<div class ="box3">
								...
								<h1 style ="text-align: center;font-size: 37px ; "> List of an exam enrty   </h1>
								<br>
				...
				{
					$q=mysqli_query($conn,"SELECT *FROM examenrty where Registration_No like '%$_POST[search]%' ");
					...
					{
						$res=mysqli_query($conn,"SELECT * FROM examenrty ORDER BY examenrty.Registration_No ASC;");
